...
namespace NetCoreYouTube.Recursos
{
    ...
    {
        //public static string cadenaConexion = "Data Source=.;Initial Catalog=Test;User ID=angels;Password=";
        public static string cadenaConexion = "Server=localhost; Database=Test; Integrated Security=True; TrustServerCertificate=True;";
